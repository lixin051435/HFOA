...
<body>
	<div class="mdiv" style="width:80%;height:400px;">
		<table id="llbinfo" class="easyui-datagrid" title="业务招待费年度预算"
			...
			<thead>
				<tr>
					...
					<th 
						data-options="field:'adjustSum',width:fixWidth(0.2),formatter:adjustSumOper,align:'center'">当前预算（万元）</th>
					<th 
						data-options="field:'order',hidden:true">当前预算（万元）</th>
					<th
						data-options="field:'usedSum',width:fixWidth(0.2),formatter:usedSumOper,align:'center'">发生额（万元）</th>
					<th
						data-options="field:'percent',width:fixWidth(0.2),formatter:percentOper,align:'center'">执行率（%）</th>
					<th
						data-options="field:'budgetSum0',width:fixWidth(0.2),align:'center'">初始预算</th>
					<!-- <th
